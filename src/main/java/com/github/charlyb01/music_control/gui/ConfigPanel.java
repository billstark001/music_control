...
public class ConfigPanel extends WBox {
    ...
    private void backToMusicScreen(PackRepository manager) {
        ...
        ClientCompat.setScreen(this.client, this.previousScreen);
    ...
    private void setupResourcePackPanel() {
        ...
        enableButton.setOnClick(() -> {
            this.previousScreen = ClientCompat.getScreen(this.client);
            ClientCompat.setScreen(this.client, new PackSelectionScreen(
    ...
    private void setupConfigMusicPanel() {
        ...
        if (ResourcePackUtils.needsMigration()) {
            ...
            migrateButton.setOnClick(() -> {
                Screen current = ClientCompat.getScreen(this.client);
                ClientCompat.setScreen(this.client, new MigrateScreen(current));
            });
