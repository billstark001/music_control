...
public class MusicKeyBinding {
    ...
    private static void registerKeys() {
        previousMusic = KeyBindingHelper.registerKeyBinding(new KeyMapping(
        ...
        nextMusic = KeyBindingHelper.registerKeyBinding(new KeyMapping(
        ...
        pauseResume = KeyBindingHelper.registerKeyBinding(new KeyMapping(
        ...
        loopMusic = KeyBindingHelper.registerKeyBinding(new KeyMapping(
        ...
        previousCategory = KeyBindingHelper.registerKeyBinding(new KeyMapping(
        ...
        nextCategory = KeyBindingHelper.registerKeyBinding(new KeyMapping(
        ...
        printMusic = KeyBindingHelper.registerKeyBinding(new KeyMapping(
